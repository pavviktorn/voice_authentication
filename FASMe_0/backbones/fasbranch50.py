...
class FASBranch50(nn.Module):

    def __init__(self, backbone='resnet50'):
        super(FASBranch50, self).__init__()
    ...
    def forward(self, x):
        ...
        add_cls_feat = global_feat_1 + adm_final_feat1
        add_cls_feat = add_cls_feat.reshape(add_cls_feat.shape[0], -1)
        cls_feat = self.mlp(add_cls_feat)
