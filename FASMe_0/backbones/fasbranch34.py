...
class FASBranch34(nn.Module):

    def __init__(self, backbone='resnet34'):
        super(FASBranch34, self).__init__()
    ...
    def cal_gamma_beta(self, x1):
        ...
        return x1_5, gamma, beta, x1_4, global_feat
    ...
    def forward(self, x):
        if self.training:
            ...
            x1, gamma1, beta1, x4_1, global_feat_1 = self.cal_gamma_beta(x)
        fea_x1_x1 = x1
        ...
        cls_feat = global_feat_1 + adm_final_feat1
        cls_feat = cls_feat.reshape(cls_feat.shape[0], -1)

        final_cls_feat = cls_feat + fea_x1_x1
